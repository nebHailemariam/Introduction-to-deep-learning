...
def test_mcq_1():
    return 'b' == mcq.question_1()


def test_mcq_2():
    return 'd' == mcq.question_2()


def test_mcq_3():
    return 'b' == mcq.question_3()


def test_mcq_4():
    return 'a' == mcq.question_4()


def test_mcq_5():
    return 'd' == mcq.question_5()

def test_mcq_6():
    res= 'a' == mcq.question_6()
    if (res==False):
        print("Wrong answer for MCQ 6!")
    return res

def test_mcq_7():
    res = 'a' == mcq.question_7()
    if (res==False):
        print("Wrong answer for MCQ 7!")
    print('-' * 20)
    return res
...
def test_cnn_correctness_conv1d_once(idx):
    ...
    model = nn.Conv1d(in_c, out_c, kernel, stride, padding)
...
def test_simple_scanning_mlp():
    ...
    try:
        ...
        print("Simple Scanning MLP Forward:" + "PASS")
        print('-' * 20)
    except Exception as e:
        print("Simple Scanning MLP Forward:" + "FAIL")
        traceback.print_exc()
        print('-' * 20)
        return False
    
    ##########################################################################
    ##########################    Get your backward results and compare ######
    ##########################################################################
    
    result = cnn.backward(result)
    expected_result = np.load(
        os.path.join(
            'autograder',
            'ref_result',
    ...
    try:
        ...
        print("Simple Scanning MLP Backward:" + "PASS")
        print('-' * 20)
        return True
    except Exception as e:
        print("Simple Scanning MLP Backward:" + "FAIL")
        traceback.print_exc()
        print('-' * 20)
        return False
...
def test_distributed_scanning_mlp():
    ...
    try:
        ...
        assert(result.shape == expected_result.shape)
        assert(np.allclose(result, expected_result))
        print("Distributed Scanning MLP Forward:" + "PASS")
        print('-' * 20)
        True
    except Exception as e:
        print("Distributed Scanning MLP Forward:" + "FAIL")
        print('-' * 20)
        traceback.print_exc()
        return False
    ...
    try:
        ...
        assert(result.shape == expected_result.shape)
        assert(np.allclose(result, expected_result))
        print("Distributed Scanning MLP Backward:" + "PASS")
        print('-' * 20)
        return True
    except Exception as e:
        print("Distributed Scanning MLP Backward:" + "FAIL")
        print('-' * 20)
        traceback.print_exc()
        return False
...
tests = [
    ...
    {
        'name': '5.5.4 - MeanPool2d | 5 points',
        'autolab': 'MeanPool2d',
